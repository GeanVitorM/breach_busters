...
const Home = ({ bgColor , title, subTitle, text }) => {
  return (
    <div className={`flex items-center justify-center min-h-screen ${bgColor} text-white`} style={{ fontFamily: 'Anonymous Pro  , sans-serif' }}>
      <div className="flex flex-col md:flex-row items-center justify-between max-w-6xl mx-auto px-4 py-12">
        <div className="md:w-1/2 text-center md:text-left">
          ...
          <a href="#contact" style={{ fontFamily: 'Tomorrow   , sans-serif' }} className="bg-gradient-to-r from-purple-400 to-blue-400 hover:from-purple-600 hover:to-blue-600 text-white font-bold py-2 px-8 rounded-full">
            BECOME BREACHLESS
          </a>
        </div>
