...
const ValuesAndZens = () => {
    return (
        <div className="bg-[#38347c] text-white py-12 px-6 text-center relative">
            <div className="absolute top-0 left-0 w-full h-0.5 bg-white"></div>
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Valores e Zens</h1>
            ...
            <div className="relative max-w-3xl mx-auto">
                ...
                <div className="relative bg-[#212940] text-[#e8e8e8] font-mono p-6 pl-10 shadow-lg text-left">
