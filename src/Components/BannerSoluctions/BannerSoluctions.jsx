          ...
          >
            {bannerItems.map((item, index) => (
              <SwiperSlide key={index}>
                <div className="text-center p-5 rounded-lg transition duration-300 hover:bg-white/20 hover:backdrop-filter hover:backdrop-blur-lg bg-opacity-90 bg-[#000000]">
